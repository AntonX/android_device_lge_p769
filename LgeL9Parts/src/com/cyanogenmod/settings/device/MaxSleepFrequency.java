...
public class MaxSleepFrequency implements OnPreferenceChangeListener {

    private static final String FILE = "/sys/devices/system/cpu/cpu0/cpufreq/screen_off_max_freq";
