...
class VibratorHW {
    ...
    private static final String NFORCE_PATH = "/sys/devices/platform/tspdrv/nforce_timed";

    static public boolean isSupported() { return Utils.fileExists(NFORCE_PATH); }
    static public int getMaxIntensity() { return 127; }
    static public int getMinIntensity() { return 32; }
    static public int getCurIntensity() { return Integer.parseInt(Utils.readOneLine(NFORCE_PATH)); }
    static public int getDefaultIntensity() { return 120; }
    static public void setIntensity(int intensity) { Utils.writeValue(NFORCE_PATH, String.valueOf(intensity)); }
}
...
public class VibratorIntensity extends DialogPreference implements SeekBar.OnSeekBarChangeListener {
    ...
    public VibratorIntensity(Context context, AttributeSet attrs) {
        ...
        setDialogLayoutResource(R.layout.preference_vibrator_intensity);
    }

    @Override
    protected void onPrepareDialogBuilder(AlertDialog.Builder builder) {
        builder.setNeutralButton(R.string.button_reset,
